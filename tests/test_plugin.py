...
Three of them now, generated by `scripts/build_plugin.py` from the one source `src/treg/web/skill.md`:
...
ALL_SKILLS = {"codex": SKILL, "claude": CLAUDE_SKILL, "cursor": CURSOR_SKILL}
